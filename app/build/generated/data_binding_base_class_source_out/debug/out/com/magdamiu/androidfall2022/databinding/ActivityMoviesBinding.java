...
public final class ActivityMoviesBinding implements ViewBinding {
  ...
  private ActivityMoviesBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerViewMovies) {
  ...
  public static ActivityMoviesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMoviesBinding((LinearLayout) rootView, recyclerViewMovies);
    }
